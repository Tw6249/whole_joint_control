...
def main() -> int:
    ...
    parser.add_argument("--baseline-config", type=Path,
                        default=Path("experiments/hip_knee/configs/h1_real_p3_selected_mpc_hip_knee_pd.yaml"))
    parser.add_argument("--out-dir", type=Path,
                        default=Path("analysis_artifacts/mpc_velocity_compare"))
    parser.add_argument("--run-mujoco", type=Path, default=Path("scripts/simulation/run_mujoco.py"))
    ...
    parser.add_argument("--mock-runner", type=Path, default=Path("build/Debug/h1_mock_closed_loop.exe"))
