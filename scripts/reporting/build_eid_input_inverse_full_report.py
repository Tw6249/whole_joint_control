...
from scripts.reporting.report_paths import markdown_relpath, repo_relpath
...
def write_report(
    ...
    lines = [
        ...
        f"- 构建脚本：`{repo_relpath(ROOT / 'scripts' / 'reporting' / 'build_eid_input_inverse_full_report.py')}`",
        "",
    ]
